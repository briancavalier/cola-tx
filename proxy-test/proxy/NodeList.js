...
define(function(require) {
	...
	var eventify, SortedMap, classList, NodeAdapter,
		defaultIdAttribute, defaultTemplateSelector, listElementsSelector,
		colaListBindingStates, allBindingStates, undef;

	eventify = require('../eventify');

	SortedMap = require('cola/SortedMap');
	classList = require('cola/dom/classList');
	NodeAdapter = require('cola/dom/adapter/Node');
	...
	NodeListAdapter.prototype = eventify(['onAdd', 'onRemove', 'onUpdate'], {
